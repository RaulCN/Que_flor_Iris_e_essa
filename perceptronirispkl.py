...
# Orientação sobre os tamanhos típicos das sépalas
print("OBS: No conjunto de dados Iris, os tamanhos típicos das sépalas são:")
print("- Comprimento da sépala: 4.3 cm a 7.9 cm")
print("- Largura da sépala: 2.0 cm a 4.4 cm")
print("")
